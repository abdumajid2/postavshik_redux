        ...
        <header>
          ...
          <section className='flex items-center bg-gray-300 p-2 justify-between'>
            ...
            <div className='flex items-center w-[600px] pl-2 justify-between border border-gray-400 rounded-md '>
              ...
              <i className="fa-solid bg-blue-500 text-white p-3 rounded-md fa-magnifying-glass"></i>
            </div>
            <div className='flex items-center gap-2'>
              <i className="fa-solid text-blue-600 fa-location-dot"></i>
              <p>Иркутск</p>
        ...
        <footer className='bg-[#1E2126] flex justify-center p-10 items-center text-white'>
          <section className='flex justify-between gap-[3rem] '>
            ...
            <article className='flex flex-col gap-[3rem] p-5'>
              ...
              <div className='flex flex-col gap-5'>
                <div className='flex items-center gap-2'>
                  <i className="fa-solid text-blue-500 fa-location-dot"></i>
                  <p>Иркутск, ул. Ленина 123</p>
                </div>
                <div className='flex items-center gap-2'>
                  <i className="fa-solid text-blue-500 fa-phone"></i>
                  <p>8-800-550-01-09</p>
                </div>
                <div className='flex items-center gap-2'>
                  <i className="fa-solid text-blue-500 fa-clock"></i>
                  <p>Пн-Пт 8:00-18:00</p>
                </div>
                <div className='flex items-center gap-2'>
                  <i className="fa-solid text-blue-500 fa-building-columns"></i>
